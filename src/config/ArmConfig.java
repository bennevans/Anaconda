...
public class ArmConfig {
   public static final double p = 1.27;//0.7;//0.965;//0.7;
   public static final double i = 0;
   public static final double d = 0.5;//1.0;//3.75;//3.5;
   ...
   public static final double ARM_MIN = /*0.8*/1.69, ARM_MAX = /*4.04*/4.91;
}